...
//sorted   sorted Starget in a 1-to-1 manner; and reorder the mappings according to the indices of the tile images into a mapping sequence L of the form of T1 → Bj , T2 → Bj , etc   
        ...
        //save F
        try {
            ImageIO.write(F, "png", new File(secrete_i.getDirectory()+secrete_i.getFileName()+ "_F.png"));
        } catch (IOException e) {
        }

        try {
            ImageIO.write(F_Target, "png", new File(target_i.getDirectory() +target_i.getFileName()+ "_F_Target.png"));
        } catch (IOException e) {
        }
...
//                new BufferedWriter();
        File redf = new File(target_i.getDirectory()+"_RED.txt");
        if (redf.exists()) {
            redf.delete();
        }
        File greenf = new File(target_i.getDirectory()+"_GREEN.txt");
        if (greenf.exists()) {
            greenf.delete();
        }
        File bluef = new File(secrete_i.getDirectory()+"_BLUE.txt");
        if (bluef.exists()) {
            bluef.delete();
        }
 File r=new File(target_i.getDirectory()+"_RED.txt");
 File g=new File(target_i.getDirectory()+"_GREEN.txt");
 File b=new File(secrete_i.getDirectory()+"_BLUE.txt");
...
blk_no = 0;
        ...
        //save F
        try {
            ImageIO.write(F_rec_from_Tiles, "png", new File(secrete_i.getDirectory()+secrete_i.getFileName()+ "_F_rec_from_Tiles.png"));
        } catch (IOException e) {
        }
        ...
        try {
            ...
            ImageIO.write(F_Target__rec_from_Tiles, "png", new File(target_i.getDirectory()+target_i.getFileName()+"_F_Target__rec_from_Tiles.png"));
...
//                new BufferedWriter();
 ...
 File rr=new File(target_i.getDirectory()+"_REDr.txt");
 File gr=new File(target_i.getDirectory()+"_GREENr.txt");
 File br=new File(secrete_i.getDirectory() +"_BLUEr.txt");
 FileWriter fileWriter_redr = new FileWriter(rr);
 FileWriter fileWriter_greenr = new FileWriter(gr);
 FileWriter fileWriter_bluer = new FileWriter(br);
 ...
 boolean underflow_blue=false;
   ...
   //2 the number m of bits to encode the index of a block
                ...
                fileWriter_redr.write(TOTAL_NO_BLOKS+"\n");
                fileWriter_greenr.write(TOTAL_NO_BLOKS +"\n");
                fileWriter_bluer.write(TOTAL_NO_BLOKS+"\n");
...
//RMSE value.
                ...
                //4.1 index of block B secrete
                 
                int length = Integer.toBinaryString(TOTAL_NO_BLOKS).length();
                 toBinaryString = Integer.toBinaryString(Secrete.INDEX[blk_no]);
                if (toBinaryString.length() < length) {
                    int dif = length - toBinaryString.length();
                    for (int tv = 0; tv < dif; tv++) {
                        String zero = "0";
                ...
                fileWriter_redr.write(Secrete.INDEX[blk_no]+" ");
                fileWriter_greenr.write(Secrete.INDEX[blk_no] +" ");
                fileWriter_bluer.write(Secrete.INDEX[blk_no] +" ");
                ...
                fileWriter_red.write(toBinaryString+" " );
                fileWriter_redr.write(((int) (100 * Math.random()) % 4)+" " );
                ...
                fileWriter_green.write(toBinaryString +" ");
                fileWriter_greenr.write(((int) (100 * Math.random()) % 4) +" ");
                ...
                fileWriter_bluer.write(((int) (100 * Math.random()) % 4) +" ");
                //4.3 mean of T
                ...
                fileWriter_red.write(toBinaryString+" ");
                fileWriter_redr.write(meanRed_Target[blk_no]+" ");
                ...
                fileWriter_green.write(toBinaryString+" ");
                fileWriter_greenr.write(meanGreen_Target[blk_no]+" ");
                ...
                fileWriter_blue.write(toBinaryString +" ");
                fileWriter_bluer.write(meanBlue_Target[blk_no]+" ");
                ...
                fileWriter_red.write(toBinaryString+" ");
                fileWriter_redr.write(meanRed_Secrete[blk_no]+" ");
                ...
                fileWriter_green.write(toBinaryString+" " );
                fileWriter_greenr.write(meanGreen_Secrete[blk_no]+" ");
              ...
              //System.out.println();
                ...
                fileWriter_blue.write(toBinaryString+" ");
                fileWriter_bluer.write(meanBlue_Secrete[blk_no]+" ");
                ...
                fileWriter_red.write(toBinaryString+" ");
                fileWriter_redr.write((r_std_dev_q*100)+" ");
                fileWriter_greenr.write((g_std_dev_q*100)+" ");
                ...
                fileWriter_blue.write(toBinaryString+" ");
                fileWriter_bluer.write((b_std_dev_q*100)+" ");
                //4.6 overflow
           ...
           //     fileWriter_green.write(toBinaryString+" ");
             ...
             //   fileWriter_blue.write(toBinaryString+" ");
               ...
               // max_std_dev
                ...
                fileWriter_red.write(toBinaryString+" " );
                fileWriter_redr.write(std_dev_Red_Target[blk_no]+" " );
                ...
                fileWriter_red.write(toBinaryString+" " );
                fileWriter_redr.write(std_dev_Red_Secrete[blk_no]+" " );             
               ...
               // max_std_dev
                ...
                fileWriter_green.write(toBinaryString+" " );
                fileWriter_greenr.write(std_dev_Green_Target[blk_no]+" " );
                 length =  Integer.toBinaryString((int)max_std_dev).length();
                 length = 8;
                ...
                fileWriter_green.write(toBinaryString+" " );
                fileWriter_greenr.write(std_dev_Green_Secrete[blk_no]+" " );
               ...
               // max_std_dev
                ...
                fileWriter_blue.write(toBinaryString+" " );
                fileWriter_bluer.write(std_dev_Blue_Target[blk_no]+" " );
                 length =  Integer.toBinaryString((int)max_std_dev).length();
                 length = 8;
                ...
                fileWriter_blue.write(toBinaryString+" " );
                fileWriter_bluer.write(std_dev_Blue_Secrete[blk_no]+" " );
                
                fileWriter_red.write("\n");
                fileWriter_green.write("\n");
                fileWriter_blue.write("\n");
                
                fileWriter_redr.write("\n");
                fileWriter_greenr.write("\n");
                fileWriter_bluer.write("\n");
...
////System.out.println("max_red_res_length="+max_red_res_length+"max_green_res_length="+max_green_res_length+"max_blue_res_length="+max_blue_res_length+"max_red_std_dev="+max_red_std_dev+"max_green_std_dev="+max_green_std_dev+"max_blue_std_dev="+max_blue_std_dev);
        ...
        try {
            F_Target__rec_from_Tiles = ColorTransform(image_Secrete, image_Target);
            F_stego=ColorTransform(image_Secrete, image_Target);
            ImageIO.write(F_Target__rec_from_Tiles, "png", new File(secrete_i.getDirectory()+secrete_i.getFileName()+ "_F_Target__rec_from_Tiles.png"));
        ...
        String args[]=new String[4];
        args[0]= "-i";
        args[1]= target_i.getDirectory()+target_i.getFileName()+"_F_stego.png";	
        args[2]="-o";
        args[3]= target_i.getDirectory()+target_i.getFileName()+"_F_stego_compressed.png";
        TERcode(args);
        //TERdisplay();
        display_images();
        ////System.out.println("END OF ALG");
 ...
 public static void TERdisplay( ){
		//Parse arguments
              String args[]=new String[2];
               args[0]= "-i";
               args[1]= secrete_i.getDirectory()+secrete_i.getFileName()+ "_F_stego_compressed.png.rec";
    ...
    private static void display_images() {
        ...
        Panel panel_gis = new ShowImage(secrete_i.getDirectory()+secrete_i.getFileName()+"_F.png");
...
int getLSB(int data){
    ...
    private static void embed_data() {
        ...
        try {
            inputStream = new FileReader(target_i.getDirectory()+"_RED.txt");
  ...
  for (int j = 0; j <F_stego.getWidth() ; j ++) {
    for (int i = 0; i <F_stego.getHeight() ; i++) { 
     ...
     inputStream = null;
        ...
        try {
            inputStream = new FileReader(target_i.getDirectory()+"_GREEN.txt");
        } catch (FileNotFoundException ex) {
            Logger.getLogger(Secret_fragment_visible_mosaic_image_creation_Modular.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  for (int j = 0; j <F_stego.getWidth() ; j ++) {
    for (int i = 0; i <F_stego.getHeight() ; i++) { 
     ...
     inputStream = null;
        ...
        try {
            inputStream = new FileReader(target_i.getDirectory()+"_BLUE.txt");
        } catch (FileNotFoundException ex) {
            Logger.getLogger(Secret_fragment_visible_mosaic_image_creation_Modular.class.getName()).log(Level.SEVERE, null, ex);
        }
       ...
       count=0;
        try {
         ...
         try {
            inputStream = new FileReader(secrete_i.getDirectory()+"_BLUE.txt");
        } catch (FileNotFoundException ex) {
            Logger.getLogger(Secret_fragment_visible_mosaic_image_creation_Modular.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  for (int j = 0; j <F_stego.getWidth() ; j ++) {
    ...
    try {
            ImageIO.write(F_stego, "png", new File(target_i.getDirectory()+target_i.getFileName()+"_F_stego.png"));
        } catch (IOException e) {
        }
